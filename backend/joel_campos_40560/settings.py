"""
Django settings for joel_campos_40560 project.
...
ROOT_URLCONF = 'joel_campos_40560.urls'
...
WSGI_APPLICATION = 'joel_campos_40560.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "joel_campos_40560 API",
    "DESCRIPTION": "API documentation for joel_campos_40560 App",
    "VERSION": "v1",
}
